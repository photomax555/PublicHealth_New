...
public class MapsAnimalFilter extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragemnt = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapanimalfilter);
    ...
    class GetDataApi extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MapsAnimalFilter.this);
        ...
        protected void onPostExecute(Void voids) {
            ...
            for (int i = 0; i < location.size(); i++) {
                ...
                int status = gAPI.isGooglePlayServicesAvailable(MapsAnimalFilter.this);
                ...
                cmdSearch.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (q != null && !q.equals("")) {
                            Geocoder geo = new Geocoder(MapsAnimalFilter.this, Locale.getDefault());
                            try {
